...
<div class="relative">
  ...
  <p class="text-lg">Read the generated DMP below and edit it as needed. </p>
  <p class="text-base">This plan is based on the "NIH-Default DMSP" 
    ...
    >
    template
    </a> provided by National Institutes of Health (nih.gov) </p>
    <UAlert color="error" title="Remember that this draft is generated by a large language model (LLM) and may not be completely accurate. Please use your own judgment and verify important information." />
